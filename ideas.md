...
→ You can find the details about this file here [_Manifest.json file](https://developer.chrome.com/docs/extensions/mv3/manifest/)
...
[_Publish Chrome Extensions](https://developer.chrome.com/docs/webstore/register/)
